...
const VerticalCardProduct = ({ category, heading }) => {
    ...
    return (
        <div className="container mx-auto flex flex-col items-center md:block px-4 my-6 relative">
            ...
            <div
                className="flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-8 overflow-scroll scrollbar-hide"
                ref={scrollElement}
            >
                {/* Scroll Buttons */}
                <button
                    className="bg-gray-100 shadow-md rounded-full p-2 absolute top-1/2 transform -translate-y-1/2 left-[-16px] text-gray-700 hover:text-gray-900 hover:bg-gray-200 text-xl hidden md:flex items-center justify-center z-10"
                    onClick={scrollLeft}
                >
                    <FaAngleLeft />
                </button>
                <button
                    className="bg-gray-100 shadow-md rounded-full p-2 absolute top-1/2 transform -translate-y-1/2 right-[-16px] text-gray-700 hover:text-gray-900 hover:bg-gray-200 text-xl hidden md:flex items-center justify-center z-10"
                    onClick={scrollRight}
                >
                    <FaAngleRight />
                </button>
